...
public class CommunityChestCards implements ChestAndCardSpot {
    ...
    public static void drawCard(Player player1) {
        System.out.println("Model.Board.Player " + player1.getName() + " drew a Community Chest card: " + shuffleCards());
    }
    ...
    public void cards() {
        ...
        communityChestCards.put("Card2", "Model.Board.Bank error in your favor. Collect $200.");
